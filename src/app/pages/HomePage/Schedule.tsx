...
export function Schedule() {
  return (
    <>
      ...
      <Content>
        <P>
          This year's camp will run for the month of July and maybe into August
          if interest is shown. The programs we plan will cater to all kids who
          either want to work on their athletic ability or just have fun. The
          camp is every weekday from 9:30am to 3:30pm.
        </P>
        <ScheduleWrapper>
          <InsideWrapper>
        ...
        <SubTitle>
          Other sports/activities that will be covered during the week on
          rotation include:
        </SubTitle>
